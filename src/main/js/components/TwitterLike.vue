    ...
    <div class="w-25 center ba b--black-10" id="twitterlike" v-cloak>
        ...
        <div class="v-cloak--hidden">
            ...
            <div class="bg-near-white pa3">
                    <div class="label-is-down h2 flex flex-wrap justify-end items-center bb bw1 mb1 pt1 pb1" v-bind:class="{'b--dark-red': tweetIsOutOfRange, 'b--black-20': !tweetIsOutOfRange, 'label-is-up': labelIsUp, 'label-is-down': !labelIsUp}" @mouseover="evalLabelState('hi')" @mouseout="evalLabelState('ho')" role="presentation">
                    ...
                    <div style="pointer-events: all;" class="pb1 'label-is-up': labelIsUp, 'label-is-down': !labelIsUp}" @mouseover="evalLabelState('hi')" @mouseout="evalLabelState('ho')" role="presentation"></div>
...
export default Vue.extend({
    /**
     * @returns {{tweet: string, photos: string[], labelIsUp: boolean, hasFocus: boolean, hasHover: boolean}}
     */
    data() {
        return {
            tweet: "",
    ...
    methods: {
        triggerFileUpload() {
            let photoUploadLement = /** @type {HTMLButtonElement} */ (this.$refs.photoUpload);
        ...
        evalLabelState(event){
            ...
            if(event == 'ho'){
                console.log("handling hover out")
                this.hasHover = false;
                if(!this.hasFocus){
                    console.log("handling hover out without focus")
                    this.labelIsUp = false;
                }else{
                    console.log("handling hover out but has focus")
                    this.labelIsUp = true;
                }
                return;
            }
